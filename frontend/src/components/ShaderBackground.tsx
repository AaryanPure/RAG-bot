...
export function EnergyRing({
  ...
  return (
    <mesh ref={mesh} position={position}>
      ...
      <meshBasicMaterial color="#ff5722" transparent opacity={0.4} side={THREE.DoubleSide} />
    </mesh>
  )
}
  ...
  return (
    <div className="fixed inset-0 -z-10 bg-black">
      <Canvas camera={{ position: [0, 0, 5] }}>
        <ShaderPlane position={[0, 0, -2]} color1="#4a148c" color2="#ff6d00" />
        <EnergyRing radius={3} />
        <EnergyRing radius={3.2} />
      </Canvas>
    </div>
  )
}
